...
pub static BABYRITE_CONFIG: once_cell::sync::OnceCell<BabyriteConfig> = once_cell::sync::OnceCell::new();
        ...
        BABYRITE_CONFIG.set(
            serde_yaml::from_reader(
                std::io::BufReader::new(
                    std::fs::File::open("./config/config.yaml").expect("Failed to open configuration file."),
                )
